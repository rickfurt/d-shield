  ...
  return (
    <section className="bg-coolGray-50 py-4 w-full ">
      <div className="container px-4 mx-auto ">
        <div className="pt-6 bg-white overflow-hidden border border-coolGray-100 rounded-md shadow-dashboard shadow-2xl">
                  ...
                  ?.map((sensor: Sensor) => (
                    <tr
                      ...
                      className={`h-18 border-b border-coolGray-100 ${
                        sensor.status === "OFFLINE" ? styles.offline : ""
                      }`}
                    >
                      ...
                      <th
                        className={`whitespace-nowrap cursor-pointer px-4 bg-white text-sm font-medium text-center ${
          ...
          <div className="flex items-center justify-between  py-4 px-6 -m-2">
            ...
            <p
              className={
                "w-auto text-center px-2 text-sm font-semibold text-coolGray-500"
              }
            >
              CLick on the status to alternate between
